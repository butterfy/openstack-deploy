...
ADMIN_PASSWORD=${ADMIN_TOKEN:-secrete}
NOVA_PASS=${NOVA_PASS:-${SERVICE_PASSWORD:-nova}}
GLANCE_PASS=${GLANCE_PASS:-${SERVICE_PASSWORD:-glance}}
NEUTRON_PASS=${NEUTRON_PASS:-${SERVICE_PASSWORD:-neutron}}
CINDER_PASS=${CINDER_PASS:-${SERVICE_PASSWORD:-cinder}}
EC2_PASSWORD=${EC2_PASS:-${SERVICE_PASSWORD:-ec2}}
SWIFT_PASSWORD=${SWIFT_PASS:-${SERVICE_PASSWORD:-swift}}

CONTROLLER_IP=$CONTROLLER
CONTROLLER_PUBLIC_ADDRESS=${CONTROLLER_PUBLIC_ADDRESS:-$CONTROLLER_IP}
CONTROLLER_ADMIN_ADDRESS=${CONTROLLER_ADMIN_ADDRESS:-$CONTROLLER_IP}
CONTROLLER_INTERNAL_ADDRESS=${CONTROLLER_INTERNAL_ADDRESS:-$CONTROLLER_IP}
